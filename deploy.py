...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('./yolov5-master', 'custom', source ='local', path='best_u.pt',force_reload=True) ### The repo is stored locally
...
# main(vid_path="./test_images/vdo.mp4",vid_out="vid_4.mp4") ### for custom video
main(vid_path=0,vid_out="webcam_facemask_result.mp4") #### for webcam

# main(img_path="./test_images/Cars118.jpg") ## for image
